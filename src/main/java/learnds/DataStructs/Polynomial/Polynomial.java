package DataStructs.Polynomial;
...
public class Polynomial {
    ...
    /**
     * <b>Multiplies the entire expression Polynomial <i>poly1</i> with  term having <i>exponent exp</i>
    ...
    public static PolyExp subPoly(PolyExp poly1,PolyExp poly2){
        ...
        poly.attach(poly1.getRaw());
        double [][] terms2 = poly2.getRaw();
        for (double [] term2 : terms2) poly.appendTerm(term2[0]*(-1),(int)term2[1]);
        return sort(poly);
    }
}
